...
export class ImageMoveRightBlock extends Block {
    public constructor() {
      super("ImageMoveRightBlock", _color);
      ...
      this._label2.setText("stappen naar rechts");
    ...
    public execute(flowcontroller: FlowController): void {
      flowcontroller.setAction(this._stappeninput.getBlock(), () => {
        this.notifyObservers("move:" + this._choice.getValue() + ":x:" + (this._stappeninput.getValue() as number));
