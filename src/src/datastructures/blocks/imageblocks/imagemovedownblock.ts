...
export class ImageMoveDownBlock extends Block {
    public constructor() {
      super("ImageMoveDownBlock", _color);
      ...
      this._label2.setText("stappen omlaag");
    ...
    public execute(flowcontroller: FlowController): void {
      flowcontroller.setAction(this._stappeninput.getBlock(), () => {
        this.notifyObservers("move:" + this._choice.getValue() + ":y:" + (this._stappeninput.getValue() as number));
