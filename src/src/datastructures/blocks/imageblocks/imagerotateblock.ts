...
export class ImageRotateBlock extends Block {
    public constructor() {
      super("ImageRotateBlock", _color);
    ...
    public execute(flowcontroller: FlowController): void {
      flowcontroller.setAction(this._stappeninput.getBlock(), () => {
        this.notifyObservers("move:" + this._choice.getValue() + ":rot:" + (this._stappeninput.getValue() as number));
